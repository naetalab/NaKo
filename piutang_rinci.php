...
<body>
<?php
	$param="SELECT * FROM piutang WHERE jual_id='$_GET[id]'";
...
<table border="0" cellspacing="1" cellpadding="0">
  ...
  <tr>
    <td id="noBorder">Piutang Awal</td>
    <td id="noBorder">:</td>
    <td id="noBorder"><?php echo "Rp ".digit($dparam['piutang_awal']); ?></td>
  </tr>
  <tr>
...
<table cellspacing="1" cellpadding="0">
  ...
  <?php
  	$sql="SELECT * FROM piutang_detail WHERE jual_id='$_GET[id]' ORDER BY inc ASC";
