...
$a="SELECT * FROM simpan";
$b="SELECT inc FROM simpan ORDER BY inc DESC LIMIT 1";
$inc=penambahan($a, $b);
...
<div class="header"><h1>Transaksi simpan</h1></div>
<div class="halaman">
  <div class="tengah">
	<div class="batas_isi">
    <div class="isi">
  ...
  <tr>
    <td>
      <form id="form1" name="form1" method="post" action="proses.php">
            <input type="hidden" name="proses" id="proses" value="saving_insert" />
          <table border="0" cellspacing="1" cellpadding="0">
          ...
          <tr>
            <td id="noborder">Tgl Masuk</td>
            <td id="noborder">:</td>
            <td id="noborder"><label>
              <input type="text" name="tgl_nabung" id="datepicker1" />
            </label></td>
          </tr>
          <tr>
            <td id="noborder">&nbsp;</td>
