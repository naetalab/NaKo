...
<body>
<div id="judulHalaman"><strong>Form bayar simpan</strong></div>
<form id="form1" name="form1" method="post" action="proses.php">
<input name="jual_id" type="hidden" value="<?php echo "$jual_id"; ?>" />
<input name="proses" type="hidden" value="simpan_bayar" />
  <table border="0" cellspacing="1" cellpadding="0">
    <tr>
      ...
      <td>
	  	<?php 
			$sql="SELECT * FROM simpan WHERE jual_id='$jual_id'";
    ...
    <tr>
      ...
      <td>
	  	...
	  	<?php 
			$hutang="SELECT * FROM simpan_detail WHERE jual_id='$jual_id' ORDER BY inc DESC";
